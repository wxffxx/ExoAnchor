...
- Production TypeC/rev1 使用单 ESP32-P4 模组和 DP83825I；GPIO17/18
  分别控制 MS2109 的 3V3_MS/1V2_SYS，GPIO50/51 分别为 Power/Reset，
  GPIO52/53 分别为低有效 12V/3V3AUX 检测。物理 AT24C16 未连接 P4，
  因此不启用 EEPROM 测试或模拟接口。
...
[`boards/exoanchor-prototype-v2.4.md`](boards/exoanchor-prototype-v2.4.md)。它与
Production TypeC、Production TypeW 以及 `v2.4-ms-test` 都是独立身份；板名、
端口、IP 或现有固件自报不能作为实物识别依据。

...
This document is scoped to the ExoAnchor agent runtime. For the whole ExoAnchor roadmap across hardware, firmware, agent runtime, and documentation, see [../docs/project/ROADMAP.md](../docs/project/ROADMAP.md).
...
- 为服务端 session/plan 接口增加 request/response logging
...
- [dev_app.py](/Users/wxffxx/Documents/26s/SI_server/simpleipmi_restructure/exoanchor/server/dev_app.py) 只负责装配本地开发服务，不再承载任务执行分支

...
def heuristic_force_plan(original_message: str) -> dict | None:
    """No benchmark-specific fallback plans.

    If the model fails to produce a usable plan, the runtime should surface the
    failure instead of injecting a human-written deployment recipe.
    """
    return None
